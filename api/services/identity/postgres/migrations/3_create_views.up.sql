...
SELECT r.role_id, r.admin_only, r.display_name, r.description, r.created_at, r.updated_at,
	ARRAY_AGG(permissions.method) AS permissions FROM roles r
